/**
 * Rosette Award Template (No Watermark)
 * 
 * 800x800 PNG standalone rosette badge for awards and achievements without watermark.
 */
...
export function RosetteAwardNoWatermark(props: Record<string, unknown>): React.ReactElement {
  const {
    rank = 1,
