/**
 * Social Square Template (No Watermark)
 * 
 * 1080x1080 PNG for Instagram and Facebook posts without watermark.
 */
...
export function SocialSquareNoWatermark(props: Record<string, unknown>): React.ReactElement {
  const {
    rank = 1,
