/**
 * Social Post Template (No Watermark)
 * 
 * 1080x1350 PNG for Instagram and Facebook Posts without watermark.
 */
...
export function SocialPostNoWatermark(props: Record<string, unknown>): React.ReactElement {
  const {
    rank = 1,
