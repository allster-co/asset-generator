/**
 * Certificate A4 Template (No Watermark)
 * 
 * A4 PDF certificate for print without watermark.
...
export function CertificateA4NoWatermark(props: Record<string, unknown>): React.ReactElement {
  const {
    rank = 1,
