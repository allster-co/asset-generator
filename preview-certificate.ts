/**
 * Preview Script for Certificate A4
 * 
 * Generates a preview PDF of the certificate-a4 template
 */
...
async function generatePreview() {
  console.log('Generating certificate-a4 preview...\n');
  ...
  try {
    ...
    // Save to file
    const outputPath = join(__dirname, 'certificate-preview.pdf');
